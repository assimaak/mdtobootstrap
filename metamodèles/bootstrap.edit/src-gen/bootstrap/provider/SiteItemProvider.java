...
/**
 * This is the item provider adapter for a {@link bootstrap.Site} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SiteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BootstrapPackage.Literals.SITE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BootstrapPackage.Literals.SITE__BLOCS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case BootstrapPackage.SITE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case BootstrapPackage.SITE__BLOCS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(BootstrapPackage.Literals.SITE__BLOCS, BootstrapFactory.eINSTANCE.createHeader()));

		newChildDescriptors.add(createChildParameter(BootstrapPackage.Literals.SITE__BLOCS,
