 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrap.impl.SiteImpl#getName <em>Name</em>}</li>
 *   <li>{@link bootstrap.impl.SiteImpl#getBlocs <em>Blocs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiteImpl extends MinimalEObjectImpl.Container implements Site {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BootstrapPackage.SITE__NAME, oldName, name));
	}
	...
	public EList<Block> getBlocs() {
		if (blocs == null) {
			blocs = new EObjectContainmentEList<Block>(Block.class, this, BootstrapPackage.SITE__BLOCS);
		}
		return blocs;
	}
