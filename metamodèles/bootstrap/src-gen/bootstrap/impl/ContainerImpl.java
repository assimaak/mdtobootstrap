 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrap.impl.ContainerImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link bootstrap.impl.ContainerImpl#getRow <em>Row</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends BlockImpl implements bootstrap.Container {
	/**
	...
	public EList<Block> getBlock() {
		if (block == null) {
			block = new EObjectContainmentEList<Block>(Block.class, this, BootstrapPackage.CONTAINER__BLOCK);
		}
		return block;
	}
	...
	public EList<Row> getRow() {
		if (row == null) {
			row = new EObjectContainmentEList<Row>(Row.class, this, BootstrapPackage.CONTAINER__ROW);
		}
		return row;
	}
