 ...
 *******************************************************************************/
package projet.bootstrap.generator.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/projet/bootstrap/generator/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(bootstrap.BootstrapPackage.class)) {
            resourceSet.getPackageRegistry().put(bootstrap.BootstrapPackage.eINSTANCE.getNsURI(), bootstrap.BootstrapPackage.eINSTANCE);
        }
