...
/**
 * This is the item provider adapter for a {@link siteWeb.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends ElementGraphiqueItemProvider {
	/**
	...
	protected void addLienPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Image_lien_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Image_lien_feature", "_UI_Image_type"),
						SiteWebPackage.Literals.IMAGE__LIEN, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Image) object).getLien();
	...
	public void notifyChanged(Notification notification) {
		...
		case SiteWebPackage.IMAGE__LIEN:
