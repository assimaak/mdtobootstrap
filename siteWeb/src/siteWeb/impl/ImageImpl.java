 ...
 * </p>
 * <ul>
 *   <li>{@link siteWeb.impl.ImageImpl#getLien <em>Lien</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageImpl extends ElementGraphiqueImpl implements Image {
	/**
	...
	protected EClass eStaticClass() {
		return SiteWebPackage.Literals.IMAGE;
	}
	...
	public void setLien(String newLien) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiteWebPackage.IMAGE__LIEN, oldLien, lien));
	}
